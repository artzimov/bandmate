...
import { RadixButton } from "./ui/RadixButton";
	...
	return (
		<div className={styles.header}>
			<span className={styles.logo}>
				...
				<RadixButton variant="ghost" className={styles.ghost} onClick={cleanLocalStorage}>
			...
			<span className={styles.logo}>
				...
				<button className={"button " + styles["theme-switch"]} onClick={toggleTheme} title="Switch theme">
